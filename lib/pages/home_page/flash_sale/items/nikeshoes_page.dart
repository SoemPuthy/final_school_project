...
class NikeShoesPage extends StatefulWidget {
  const NikeShoesPage({Key? key}) : super(key: key);

  @override
  State<NikeShoesPage> createState() => _NikeShoesPageState();
}
            ...
            Container(
              ...
              child: GestureDetector(
                child: Card(
                  ...
                  child: Image.asset('assets/img/nikeshoes2.png'),
                ),
              ),
            ),
            Container(
