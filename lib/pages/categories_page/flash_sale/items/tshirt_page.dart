...
class TshirtProductPage extends StatefulWidget {
  const TshirtProductPage({Key? key}) : super(key: key);

  @override
  State<TshirtProductPage> createState() => _TshirtProductPageState();
}

class _TshirtProductPageState extends State<TshirtProductPage> {
  double rating = 0;
  @override
