...
class BallProductPage extends StatefulWidget {
  const BallProductPage({Key? key}) : super(key: key);

  @override
  State<BallProductPage> createState() => _BallProductPageState();
}

class _BallProductPageState extends State<BallProductPage> {
  double rating = 0;
  @override
