...
class ReaderProductPage extends StatefulWidget {
  const ReaderProductPage({Key? key}) : super(key: key);

  @override
  State<ReaderProductPage> createState() => _ReaderProductPageState();
}

class _ReaderProductPageState extends State<ReaderProductPage> {
  double rating = 0;
  @override
